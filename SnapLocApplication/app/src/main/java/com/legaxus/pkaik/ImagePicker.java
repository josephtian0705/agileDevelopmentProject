...
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context) {
       ...
       // if (intentList.size() > 0) {
            chooserIntent = Intent.createChooser(takePhotoIntent,
                    "Choose");
    ...
    public static Bitmap getImageFromResult(Context context, int resultCode,
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (isCamera) {     /** CAMERA **/
                selectedImage =FileProvider.getUriForFile(context,context.getApplicationContext().getPackageName() + ".my.package.name.provider",imageFile);
            } else {            /** ALBUM **/
